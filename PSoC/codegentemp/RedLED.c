...
#define SetP4PinDriveMode(shift, mode)  \
    do { \
        RedLED_PC =   (RedLED_PC & \
                                (uint32)(~(uint32)(RedLED_DRIVE_MODE_IND_MASK << (RedLED_DRIVE_MODE_BITS * (shift))))) | \
                                (uint32)((uint32)(mode) << (RedLED_DRIVE_MODE_BITS * (shift))); \
    } while (0)
...
{
	SetP4PinDriveMode(RedLED__0__SHIFT, mode);
}
