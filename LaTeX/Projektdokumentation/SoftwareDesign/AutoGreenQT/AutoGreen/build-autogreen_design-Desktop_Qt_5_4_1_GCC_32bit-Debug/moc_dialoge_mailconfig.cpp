...
#include "../autogreen_design/dialoge_mailconfig.h"
...
struct qt_meta_stringdata_DialogE_mailConfig_t {
    QByteArrayData data[1];
    char stringdata[19];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_DialogE_mailConfig_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_DialogE_mailConfig_t qt_meta_stringdata_DialogE_mailConfig = {
    {
QT_MOC_LITERAL(0, 0, 18) // "DialogE_mailConfig"
...
const QMetaObject DialogE_mailConfig::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_DialogE_mailConfig.data,
      qt_meta_data_DialogE_mailConfig,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *DialogE_mailConfig::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DialogE_mailConfig.stringdata))
